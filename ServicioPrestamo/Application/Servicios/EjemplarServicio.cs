...
public class EjemplarServicio : IEjemplarServicio
{
    ...
    public Result<Ejemplar> Create(Ejemplar dto)
    {
        ...
        if (!validacion.IsSuccess)
            return Result<Ejemplar>.Failure(validacion.Error);
        ...
        return Result<Ejemplar>.Success(dto);
    }

    public Result<Ejemplar> Update(Ejemplar dto)
    {
        var ejemplarExistente = _ejemplarRepositorio.GetById(dto.EjemplarId);
        if (ejemplarExistente == null)
            return Result<Ejemplar>.Failure(EjemplarErrors.ErrorProcesado);
    ...
    public Result Delete(Ejemplar dto)
    {
